...
module RusticiSoftwareCloudV2
  ...
  class SettingMetadata
    ...
    def self.swagger_types
      {
        ...
        :'level' => :'String',
        :'learning_standards' => :'Array<String>',
        :'learning_standard_variant' => :'String',
        :'fallback' => :'String',
        :'valid_values' => :'Array<SettingMetadataValidValues>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'learningStandards')
        if (value = attributes[:'learningStandards']).is_a?(Array)
          self.learning_standards = value
        end
      end
      ...
      if attributes.has_key?(:'validValues')
        if (value = attributes[:'validValues']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          level == o.level &&
          learning_standards == o.learning_standards &&
          learning_standard_variant == o.learning_standard_variant &&
          fallback == o.fallback &&
