...
module RusticiSoftwareCloudV2
  class ImportResultSchema
    ...
    attr_accessor :course_languages
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'parserWarnings')
        if (value = attributes[:'parserWarnings']).is_a?(Array)
          self.parser_warnings = value
        end
      end

      if attributes.has_key?(:'courseLanguages')
        if (value = attributes[:'courseLanguages']).is_a?(Array)
          self.course_languages = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          web_path_to_course == o.web_path_to_course &&
          parser_warnings == o.parser_warnings &&
          course_languages == o.course_languages &&
          course == o.course
    end
