...
module RusticiSoftwareCloudV2
  ...
  class XapiActivityDefinition
    ...
    def self.swagger_types
      {
        ...
        :'choices' => :'Array<XapiInteractionComponent>',
        :'scale' => :'Array<XapiInteractionComponent>',
        :'source' => :'Array<XapiInteractionComponent>',
        :'target' => :'Array<XapiInteractionComponent>',
        :'steps' => :'Array<XapiInteractionComponent>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'correctResponsesPattern')
        if (value = attributes[:'correctResponsesPattern']).is_a?(Array)
          self.correct_responses_pattern = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          correct_responses_pattern == o.correct_responses_pattern &&
          choices == o.choices &&
          scale == o.scale &&
          source == o.source &&
          target == o.target &&
